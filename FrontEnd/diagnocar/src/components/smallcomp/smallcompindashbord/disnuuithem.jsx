...
const DisneyThemedCheckbox = () => {
  ...
  const handleCheckboxChange = () => {
    ...
    // Add logic here to handle the checkbox state change
  ...
  return (
    ...
    <label className="swap swap-rotate">
      <input type="checkbox" className="theme-controller " value="synthwave" onClick={handleCheckboxChange} />
...
export default DisneyThemedCheckbox;
